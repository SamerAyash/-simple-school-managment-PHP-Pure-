...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    if ( isset($_POST['_method']) && mysqli_real_escape_string($connection, $_POST['_method']) == 'PUT'){
        ...
        $sql = "UPDATE students SET name='$name', email='$email', phone='$phone'".$password_statment." WHERE id=$id";
        // Execute the SQL statement
        if (mysqli_query($connection, $sql)) {
            echo '<script>location.replace("'.$host.'/admin/student/index.php'.'");</script>';
        } else {
                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            <li class="breadcrumb-item">
                                <a href="<?php $host.'/admin/student'?>" class="text-muted">
                                    Teachers
                                </a>
                            </li>
                            <li class="breadcrumb-item">
                                <a href="#" class="text-muted">
                                    <?php echo $is_edit ? 'Edit student' : 'Create student'; ?>
                                </a>
                            </li>
                        </ul>
                        <!--end::Breadcrumb-->
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label"><?php echo $is_edit? 'Edit student' : 'Create new student'; ?></h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <!--begin::Example-->
                        <div class="example mb-10">
                            <div class="example-preview">
                                <form method="post" action="<?php echo $is_edit ? $host.'/admin/student/form.php?id='.$_GET['id'] : $host.'/admin/student/form.php';?>" enctype="multipart/form-data">
                                    <?php
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="<?php echo $is_edit? $student['name'] : null ?>" name="name"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-2 col-form-label">Email</label>
                                        <div class="col-10">
                                            <input class="form-control" type="email" value="<?php echo $is_edit? $student['email'] : null ?>" name="email"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label  class="col-2 col-form-label">Phone</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" value="<?php echo $is_edit? $student['phone'] : null ?>" name="phone"/>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="card-footer align-items-end">
                                        ...
                                        ?>
                                        <a href="<?php echo $host.'/admin/student/index.php'; ?>"  class="btn btn-secondary">Cancel</a>
                                    </div>
