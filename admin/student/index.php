                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="<?php echo $host?>/admin/student/index.php" class="text-muted">
                                Students
                            </a>
                        </li>
                    </ul>
        ...
        <div class=" container ">
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header">
                    ...
                    <div class="card-title">
                        <a href="<?php echo $host.'/admin/student/form.php'?>" class="btn btn-primary">
                        ...
                        <div class="example-preview">
                            <table class="table">
                                ...
                                <?php $i=1; foreach($students as $student){
                                    ...
                                    <td>'.$student['phone'].'</td>
                                    <td>
                                        <a href="'.$host."/admin/student/form.php?id=".$student['id'].'" class="btn btn-outline-primary">
                                        ...
                                        <form method="post" action="'.$host."/admin/student/index.php".'" class="btn btn-outline-danger deleteForm'.$student['id'].'" onclick="confirmDeleted('.$student['id'].')">
