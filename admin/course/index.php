                    ...
                    <div class="d-flex align-items-baseline flex-wrap mr-5">
                        ...
                        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                            <li class="breadcrumb-item">
                                <a href="<?php echo $host?>/admin/course/index.php" class="text-muted">
                                    Courses
                                </a>
                            </li>
                        </ul>
            ...
            <div class=" container ">
                ...
                <div class="card card-custom gutter-b">
                    <div class="card-header">
                        ...
                        <div class="card-title">
                            <a href="<?php echo $host.'/admin/course/form.php'?>" class="btn btn-primary">
                        ...
                        <div class="example mb-10">
                            ...
                            <div class="example-preview">
                                <table class="table">
                                    ...
                                    <td>
                                        <a href="'.$host."/admin/course/form.php?id=".$course['id'].'" class="btn btn-outline-primary">
                                        ...
                                        <form method="post" action="'.$host."/admin/course/index.php".'" class="btn btn-outline-danger deleteForm'.$course['id'].'" onclick="confirmDeleted('.$course['id'].')">
