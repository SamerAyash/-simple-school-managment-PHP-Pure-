    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
            ...
            <div
                ...
                <!--begin::Menu Nav-->
                <ul class="menu-nav ">
                    <li class="menu-item {{\Route::currentRouteName() == 'admin.home' ?'menu-item-active':''}}" aria-haspopup="true"><a href="<?php echo $host.'/'.$user_type?>" class="menu-link "><i
                                class="menu-icon flaticon-home"></i><span class="menu-text">Dashboard</span></a>
                    </li>
                    <li class="menu-item " aria-haspopup="true">
                        <form id="logoutForm" action="<?php echo $host?>/logout.php" method="post" style="margin-left: 25px" class="mt-3">
                        <?php
